  ...
  return (
    <header className="absolute top-8 left-0 w-full z-20">
      <div className="container">
        <div className="mx-auto flex items-center justify-between py-2 bg-white rounded-[35px] shadow-lg">
          <Image
            src={Headerlogo}
            alt="sapar.kg"
            width={55}
          ...
          <div className="flex items-center gap-6 text-white mr-6">
            ...
            <button className="px-5 py-1.5 bg-orange-500 text-white rounded-lg text-[15px] hover:bg-orange-600 transition">
              Войти
            </button>
